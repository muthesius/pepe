...
{
	#region PluginInfo
	[PluginInfo(Name = "Movement", Category = "Enumerations", Version = "Dynamic", Help = "Basic template with dynamic custom enumeration", Tags = "")]
	#endregion PluginInfo
	public class DynamicEnumerationsMovementNode : IPluginEvaluate
	{
		#region fields & pins
		...
		public DynamicEnumerationsMovementNode()
		{
			var s = new string[] {
				"one",
				"two"
