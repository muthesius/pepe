...
{
	#region PluginInfo
	[PluginInfo(Name = "getStates", Category = "Enumerations", Version = "Dynamic", Help = "Basic template with dynamic custom enumeration", Tags = "")]
	#endregion PluginInfo
	public class DynamicEnumerationsgetStatesNode : IPluginEvaluate
	{
		#region fields & pins
		...
		public DynamicEnumerationsgetStatesNode()
		{
			var s = new string[] {
				"one",
				"two"
